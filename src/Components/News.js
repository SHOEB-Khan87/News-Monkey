...
page:this.state.page + 1
        ...
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=9eb0d291e94d4a5fbcb89c6ac42ebbf2&page=${this.state.page +1}&pageSize=${this.props.pageSize}`;
